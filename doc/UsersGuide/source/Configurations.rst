...
mediator). This chapter documents a few of the supported regression test (RT) configurations. For a full list of 
supported RT configurations, view the `rt.conf <https://github.com/ufs-community/ufs-weather-model/blob/develop/tests/rt.conf>`__ file.
